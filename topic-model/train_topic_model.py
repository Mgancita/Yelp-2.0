...
path_model_storage = '/Users/asnafatimaali/Documents/GitHub/Yelp-2.0/topic_model/model_data'
...
if model_type == "A":
    ...
    if corpus_download == "Y":
        ...
        download = input("Please download the file from: \n https://drive.google.com/open?id=1kAQS4Nn38IwUmXBxTMwOUd-q8yiReqcJ \n Place it in the directory and type C")
        if download == "C":
            final_corpus = gensim.corpora.MmCorpus(os.path.join(path_model_storage, 'corpus.mm'))
...
# NEED TO LOOK INTO ZIP FILES, TAR FILES or IF POSSINLE THE BZ2 file 
## REMOVE COUNTERS
